...
export const MaltSvg: React.FC<IconProps> = ({}) => {
  return (
...
export const CollectiveSvg: React.FC<IconProps> = ({}) => {
  return (
      <svg xmlns="http://www.w3.org/2000/svg"
           aria-label="Collective" role="img"
           viewBox="0 0 512 512">
        <path fill="#000000"
              d="M1044 1896 c-98 -19 -137 -32 -224 -77 -263 -136 -420 -395 -420
-694 0 -601 645 -977 1159 -675 129 75 281 243 297 328 13 70 -46 132 -126
132 -47 0 -66 -17 -134 -114 -67 -96 -183 -171 -309 -201 -287 -68 -580 124
-642 420 -18 88 -18 132 0 220 62 295 355 488 640 421 130 -31 243 -104 310
-201 69 -99 88 -115 135 -115 80 0 139 62 126 132 -12 66 -117 198 -221 278
-159 123 -401 182 -591 146z"/>
      </svg>
  );
};
